# Data provider for the EXAMPLE implementation
...
def sendToMCT(run):
    ...
    UDP_PORT_SEND =   #chosen port to OpenMCT (same as in telemetry server object)
...
def command(run):
    ...
    UDP_PORT_RCV =    #chosen port to OpenMCT (same as in telemetry server object)
    data = ''
    addr = ''
    connected = False
