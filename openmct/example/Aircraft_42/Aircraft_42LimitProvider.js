...
define([
    ...
    function Aircraft_42LimitProvider() {

    }

    Aircraft_42LimitProvider.prototype.supportsLimits = function (domainObject) {
        return domainObject.type === 'Aircraft_42.telemetry';
    };

    Aircraft_42LimitProvider.prototype.getLimitEvaluator = function (domainObject) {
        return {
    ...
    return Aircraft_42LimitProvider;
});
